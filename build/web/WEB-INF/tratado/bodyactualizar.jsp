            ...
            <td>
              ...
              <fieldset id="divisionGrupo" style="margin-left: 70px; margin-top: -53px;">
                ...
                <logic:iterate id="element" name="Tratado" property="grupos" indexId="index">
                  <html:text name="Tratado" property="grupos" value="${element}"/>
                </logic:iterate>
          ...
          <tr>
            <td>
              <fieldset>
                ...
                <html:text name="Tratado" property="firmaLugar"/>
              </fieldset>
            </td>
            <td>
              <fieldset>
            ...
            <td>
              <html:checkbox name="Tratado" property="aprobado"/><span class="textoCheck" style="font-size: 15px; font-weight: bold">*Aprobado</span>
            </td>
          ...
          <tr>
            ...
            <td>
              <fieldset>
                ...
                <span class="fecha"><html:text name="Tratado" property="fechaGaceta"/></span>
              </fieldset>
            </td>
            <td>
              <fieldset>
          ...
          <tr>
            ...
            <td>
              <fieldset>
                ...
                <span class="fecha"><html:text name="Tratado" property="entradaVigor"/></span>
              </fieldset>
            </td>
            <td>
              <fieldset>
          ...
          <tr>
            ...
            <td>
              <fieldset>
                ...
                <html:text name="Tratado" property="volumen"/>
              </fieldset>
            </td>
            <td>
              <fieldset>
          ...
          <tr>
            <td colspan="4">
              <fieldset class="contenido">
                <legend>Tratado disponible en: (Debe colocar una dirección URL. Ej: http://www.google.com)</legend>
                <div class="error">
          ...
          <tr>
            <td colspan="4">
              <fieldset class="contenido">
                ...
                <html:textarea name="Tratado" property="contenido"></html:textarea>
              </fieldset>
            </td>
          </tr>
        </table>
